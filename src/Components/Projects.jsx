    ...
    return (
        ...
        <div id="projects" class="project-container py-10 border h-[850px]">
            ...
            <div className="service-contaner flex justify-between mt-4 px-6">
                <div className="shadow-2xl rounded-2xl service 1 space-y-4 bg-yellow-700 hover:bg-yellow-800 border w-full px-2">
                ...
                <div className="shadow-2xl rounded-2xl service 2 space-y-4 bg-yellow-700  hover:bg-yellow-800  border w-full ml-2">
                ...
                <div className="shadow-2xl rounded-2xl service 3 space-y-4 bg-yellow-700 hover:bg-yellow-800  border w-full ml-2">
